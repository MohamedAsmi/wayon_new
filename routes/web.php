...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => ['guest:admin']], function(){
	...
	Route::group(['middleware' => 'permission:manage_admin'], function () {
		...
		Route::match(array('GET', 'POST'), 'add-owner', 'OwnerController@add');
		Route::match(array('GET', 'POST'), 'edit-owner/{id}', 'OwnerController@update');
		Route::match(array('GET', 'POST'), 'delete-owner/{id}', 'OwnerController@delete');
	});
...
Route::group(['prefix' => 'owner', 'namespace' => 'Owner', 'middleware' => ['guest:owner']], function(){
	Route::get('/', function(){
	...
	Route::match(array('GET', 'POST'),'properties', 'PropertyController@ownerProperties');
	Route::match(['GET', 'POST'], 'payout-list', 'PayoutController@payoutList');
	...
	Route::match(array('GET', 'POST'),'profile', 'DashboardController@profile');
    Route::match(array('GET', 'POST'),'profile/media', 'DashboardController@media');
    Route::get('edit-verification', 'DashboardController@verification');
	Route::match(['get', 'post'], 'security', 'DashboardController@security');
    Route::match(['get', 'post'], 'booking/{id}', 'BookingController@index');
	Route::match(array('GET', 'POST'),'properties/{slug}', 'PropertyController@single')->name('property.single');


		Route::match(array('GET', 'POST'),'listing/{id}/photo_message', 'PropertyController@photoMessage');
		Route::match(array('GET', 'POST'),'listing/{id}/photo_delete', 'PropertyController@photoDelete');
...
Route::group(['prefix' => 'owner', 'namespace' => 'Owner', 'middleware' => 'no_auth:owner'], function () {
    Route::get('login', 'OwnerController@login');
});
...
Route::group(['middleware' => ['guest:users', 'locale']], function () {
	...
	Route::get('/makePayment', 'PaymentController@makePhonePePayment')->name('makePayment');
	Route::post('/payment-success', 'PaymentController@paymentsuccess')->name('payment.success');
	// Route::post('/make-phonepe-payment', 'PaymentController@makePhonePePayment')->name('phonepe.payment');
	// Route::get('/payments/success', 'PaymentController@paymentsuccess')->name('payment.success');
	// Route::get('/payments/failure', 'PaymentController@paymentfailure')->name('payment.failure');
    ...
    Route::get('payments/stripe', 'PaymentController@	');
...
Route::post('owner/authenticate', 'Owner\OwnerController@authenticate');