	...
	<div class="row">
			...
			<div class="col-lg-12 p-0">
				@if($booking_details->status == 'Pending')
                    ...
                    @else
                        ...
                        <p>{{ trans('messages.booking_request.not_a_confirmed_booking') }} {{ trans('messages.booking_request.hear_back_within_24') }} {{ trans('messages.booking_request.not_be_charged') }} {{$booking_details->properties->owners->username}} {{ trans('messages.booking_request.accommodate_stay') }}.</p>
                    @endif
                @endif

				@if($booking_details->status == 'Accepted')
					<h2>{{trans('messages.booking_request.get_ready')}} {{ $booking_details->properties->property_address->city }}!</h2>
					<p>{{trans('messages.booking_request.confirmed_booking')}} {{$booking_details->properties->owners->username}}. {{trans('messages.booking_request.emailed_itinerary')}} {{$booking_details->properties->users->email}}.</p>
				@endif
		...
		<div class="col-md-4">
			<div class="card mt-3 mb-5 p-3">
				<a href="{{ secure_url('/') }}/properties/{{ $booking_details->properties->slug}}">
