						...
						<div class="row">
								...
								<div class="container-inbox">
									<sidebar>
										<div class="list-wrap overflow-hidden-x">
											@forelse($messages as $message)
												...
												@php
													Auth::guard('users')->user()->id != $message->sender->id ? $user = $message->sender :$user =$message->receiver;
												@endphp
									...
									<div class="content-inbox container-fluid p-0" id="messages">
										<header>
											...
											@endphp
												<a href="{{ secure_url('/') }}/users/show/{{ $booking->$users->id}}">
							...
							<div class="col-md-3 card p-0 " id="booking">
								<div class="w-100 overflow-auto right-inbox p-3">
									<a href="{{ secure_url('/') }}/properties/{{ $booking->properties->slug }}"><h4 class="text-left text-16 font-weight-700">{{$booking->properties->name}}</h4></a>
