			...
			<div class="col-lg-10 p-0">
				<div class="container-fluid min-height">
					<div class="col-md-12">
						...
						@endphp
						@if($user->users_verification != null)
							<div class="row justify-content-center mt-5">
								<div class="col-md-12 p-0">
									...
									<div class="main-panel border main-panelbg">
										...
										<ul class="list-layout edit-verifications-list">
											...
											@if(($user->users_verification->email == 'no') && ($user->users_verification->facebook == 'no') && ($user->users_verification->google == 'no'))
												<div class="alert alert-success mt-3" role="alert">
												No Verification Available
												</div>
											@else
												@if($user->users_verification->email == 'yes')
												<li class="edit-verifications-list-item">
													<h4 class="font-weight-700 text-16">{{ trans('messages.users_dashboard.email_address') }}</h4>
													<p class="pl-4">{{ trans('messages.profile.you_have_confirmed_email') }} <b>{{ $user->email }}</b>.  {{ trans('messages.profile.email_verified') }}
													</p>
												</li>
												@endif
												<hr>
												@if($user->users_verification->facebook == 'yes')
												<li class="edit-verifications-list-item">
												...
												@if($user->users_verification->google == 'yes')
												<li class="edit-verifications-list-item">
								...
								<div class="card card-default">
									@if(!($user->users_verification->email == 'yes' && $user->users_verification->facebook == 'yes' && $user->users_verification->google == 'yes'))
									...
									<div class="p-4">
										<ul>
										@if($user->users_verification->email == 'no')
											<li>
											...
											<div class="row pl-4 pt-1">
												<div class="col-md-9">
												<p>
													{{ trans('messages.profile.email_verification') }} <b>{{ $user->email }}</b>.
												</p>
												</div>
										...
										@if($user->users_verification->facebook == 'no')
											<li>
										...
										@if($user->users_verification->google == 'no')
											<li>
												<h4 class="font-weight-700 text-16 mt-4">
