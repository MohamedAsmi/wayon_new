					...
					<div class="col-md-4">
						<div class="card card-default p-3 mt-3">
							<div class="card-body">
								...
								<a href="{{ secure_url('/') }}/trips/active"><p class="text-center font-weight-bold m-0">{{ $trip }}</p></a>
							</div>
						</div>
					</div>
												...
												<div class="table-responsive">
													...
													@if( $transactions->count() >= 9 )
														<div class="more-btn text-right mb-4 pr-4">
															<a class="btn vbtn-outline-success text-14 font-weight-700 p-0 mt-2 pl-3 pr-3" href="{{ secure_url('/') }}/users/transaction-history">
