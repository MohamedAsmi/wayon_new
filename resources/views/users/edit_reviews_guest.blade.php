									...
									<div class="row flex-column-reverse flex-md-row">
										...
										<div class="col-md-4">
											<div class="border rounded-3 p-4">
												<a href="{{ secure_url('/') }}/properties/{{ $result->property_id }}" alt="{{ $result->properties->name }}" class="media-cover">
													<img class="img-fluid" src="{{ $result->properties->cover_photo }}" alt="coverphoto">
												</a>
												<div class="mt-3">
													<div class="col-xs-12 mb20 l-pad-none r-pad-none">
														<div class="font-weight-700"><a href="{{ secure_url('/') }}/properties/{{ $result->property_id }}" alt="{{ $result->properties->name }}" class="media-cover" target="_blank">{{ $result->properties->name }}</a></div>
														{{-- <div class="text-muted">{{ $result->properties->name }} · {{ $result->properties->property_address->city }}</div> --}}
														<div class="location-title">{{ trans('messages.reviews.hosted_by') }} <a href="{{ secure_url('/') }}/users/show/{{ $result->host_id }}" class="media-cover" target="_blank">{{ $result->properties->users->full_name }}</a></div>
