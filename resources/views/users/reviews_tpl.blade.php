									...
									<div class="row mt-4 border rounded-3">
										<div class="col-md-3 col-xl-4 pl-0 pr-0">
											<div class="img-event p-3">
												<a href="{{ secure_url('/') }}/properties/{{$reviewsAboutYou[$i]->properties->slug}}">
										...
										<div class="col-md-9 col-xl-8 pl-3 pr-3">
											<div class="row align-items-center pt-2 pb-2">
												<a href="{{ secure_url('/') }}/properties/{{$reviewsAboutYou[$i]->properties->slug}}"><p class="font-weight-700 mb-0">{{ $reviewsAboutYou[$i]->properties->name }} </p></a>
											</div>
											...
											<div class="row align-items-center pt-2 pb-2">
												...
												<div class="pr-4">
													<div class="row justify-content-center">
														<div class='img-round '>
															<a href="{{ secure_url('/') }}/users/show/{{ $reviewsAboutYou[$i]->users->id }}">
													...
													<p class="text-center font-weight-700 mb-0">
														<a href="{{ secure_url('/') }}/users/show/{{ $reviewsAboutYou[$i]->users->id }}" class="text-color text-color-hover">
										...
										<div class="col-md-9 col-xl-8 p-3 pr-3">
											...
											<div class="row align-items-center pt-2 pb-2">
												<div class="col p-0">
													...
													<a href="{{ secure_url('/') }}/reviews/edit/{{ $reviewsAboutYou[$i]->booking_id }}" class="mt-2">
												...
												<div class="pr-4">
													<div class="row justify-content-center">
														<div class='img-round '>
															<a href="{{ secure_url('/') }}/users/show/{{ $reviewsAboutYou[$i]->sender_id }}">
																<img src="{{ $reviewsAboutYou[$i]->users->profile_src }}" alt="{{ $reviewsAboutYou[$i]->users->first_name }}" class="rounded-circle img-70x70">
															</a>
														</div>
													</div>
													...
													<p class="text-center font-weight-700 mb-0">
														<a href="{{ secure_url('/') }}/users/show/{{ $reviewsAboutYou[$i]->sender_id }}" class="text-color text-color-hover">
															{{ $reviewsAboutYou[$i]->users->first_name }}
														</a>
													</p>
												</div>
