        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <div class="form-group">
              <label for="exampleInputEmail1" class="control-label col-sm-3">Owner<span class="text-danger">*</span></label>
              ...
              <div class="modal-content ">
                    ...
                    <div class="modal-body">
                        ...
                        {{ csrf_field() }}
                              ...
                              <h4 class="text-info text-center ml-40">Owner Information</h4>
                              ...
                              {{csrf_field()}}
                              <div class="form-group">
                                  <label for="exampleInputPassword1" class="control-label col-sm-3">user Name<span class="text-danger">*</span></label>
                                  <div class="col-sm-8">
           ...
           if (username && email) {
              ...
              .done(function(response) {
                if (response.status == 1) {
                  ...
                  $('#host_id').append('<option data-icon-class="icon-star-alt" value="' + response.owner.id + '" selected="selected">' + response.owner.username + '</option>');
                  $('#signup_form')[0].reset();
                }
              })
              .fail(function(error) {
