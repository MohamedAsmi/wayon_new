										...
										<div class="dialogbox text-center">
											<div class="body">
												<div class="message padding-top10 padding-bottom10">
													...
													<span><a href="{{ secure_url('/') }}/search?location={{ $messages[0]->bookings->properties->property_address->city }}" class="btn ex-btn navbar-btn topbar-btn">{{ trans('messages.message.keep_searching') }}</a></span>
												</div>
											</div>
										</div>
									@endif
													...
													<div class="col-lg-12 row">
														<div class="col-md-10 col-sm-10 col-xs-9">
															<div class="dialogbox">
																<div class="body">
																	<div class="h5">
																		{{ trans('messages.message.inquiry_about') }} <a locale="en" data-popup="true" href="{{ secure_url('/') }}/properties/{{ $messages[$i]->bookings->property_id }}">{{ $messages[$i]->bookings->properties->name }}</a>
																	</div>
