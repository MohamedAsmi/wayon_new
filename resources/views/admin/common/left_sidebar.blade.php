<aside class="main-sidebar">
	...
	<ul class="sidebar-menu">
		...
		{{-- @if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_admin'))
		<li class="{{ (Route::current()->uri() == 'admin/admin-owners') || (Route::current()->uri() == 'admin/add-owner') || (Route::current()->uri() == 'admin/edit-owner/{id}') ? 'active' : ''  }}">
			<a href="{{ url('admin/admin-owners') }}">
			<i class="fa fa-user-plus"></i> <span>Hotel Owners</span>
			</a>
		</li>
		@endif --}}
		@if(Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_admin'))
			<li class="treeview {{ (Route::current()->uri() == 'admin/admin-owners' || Route::current()->uri() == 'admin/add-owner' || Route::current()->uri() == 'admin/edit-owner') ? 'active' : ''  }}">
				<a href="#">
				<i class="fa fa-building"></i> <span>Hotel Owners</span><i class="fa fa-angle-left pull-right"></i>
				</a>
				<ul class="treeview-menu">
				<li class="{{ (Route::current()->uri() == 'admin/add-owner') ? 'active' : ''  }}"><a href="{{ url('admin/add-owner') }}"><span>Add New Hotel</span></a></li>

				<li class="{{ (Route::current()->uri() == 'admin/admin-owners') ? 'active' : ''  }}"><a href="{{ url('admin/admin-owners') }}"><span>All Hotels</span></a></li>
