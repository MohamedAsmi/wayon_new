                            ...
                            <div class="list-bacground mt-4 rounded-3 pl-3 pr-3 pt-4 pb-4 border">
                                ...
                                <div class="float-right">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <form action="{{ url('owner/my-bookings') }}" method="POST" id="my-bookings-form" >
                                                {{ csrf_field() }}
                    ...
                    @forelse($bookings as $booking)
                        ...
                        <div class="row border border p-2  rounded-3 mt-4">
                            <div class="col-md-3 col-xl-4 p-2">
                                <div class="img-event">
                                    <a href="{{ secure_url('/') }}/owner/properties/{{ $booking->properties->slug }}">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-14 mt-3">
                                            @if($booking->status == 'Pending' && $booking->payment_method_id <> 4)
                                                <span>
                                                    <a href="{{ secure_url('/') }}/owner/booking/{{ $booking->id }}">
                                                        <i class="fas fa-check-square"></i> {{ trans('messages.email_template.accept/decline') }}
                                                    </a>
                                                </span>
                                            @elseif($booking->status == 'Accepted')
                                                <span>
                                                    <a href="{{ secure_url('/') }}/owner/booking/receipt?code={{ $booking->code }}">
                                    ...
                                    <div class="pr-2 mt-5 mt-sm-0">
                                        <div class="align-self-center  mt-sm-0 w-100">
                                            <div class="row justify-content-center">
                                                <div class='img-round'>
                                                    <a href="{{ secure_url('/') }}/users/show/{{ $booking->user_id }}">
                                            ...
                                            <p class="text-center font-weight-700 mb-0">
                                                <a href="{{ secure_url('/') }}/users/show/{{ $booking->user_id }}" class="text-color text-color-hover">
