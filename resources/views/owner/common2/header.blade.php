<header class="main-header">
	<a href="{{URL::to('owner/dashboard')}}" class="logo">
		@if (!empty($site_name))
			...
			<ul class="nav navbar-nav">
				<li class="dropdown user user-menu">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						<img src="{{\Auth::guard('owner')->user()->profile_src}}" class="user-image" alt="User Image">
						<span class="hidden-xs">{{ ucfirst(Auth::guard('owner')->user()->username) }}</span>
					</a>
					
					<ul class="dropdown-menu">
						<li class="user-header">
							<img src="{{\Auth::guard('owner')->user()->profile_src}}" class="img-circle" alt="User Image">
							<p>
								{{ ucfirst(Auth::guard('owner')->user()->username) }}
								<small>Member since {{ date('M, Y', strtotime(Auth::guard('owner')->user()->created_at)) }}</small>
							</p>
						</li>
				
						<li class="user-footer">
							<div class="pull-left">
							<a href="{{URL::to('/')}}/owner/profile" class="btn btn-default btn-flat">Profile</a>
							</div>
							<div class="pull-right">
							<a href="{{URL::to('/')}}/owner/logout" class="btn btn-default btn-flat">Sign out</a>
							</div>
						</li>
					</ul>
				</li>
