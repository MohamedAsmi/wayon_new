<ul class="sidenav-list">
	...
	@if (Route::current()->uri() == 'trips/active' || Route::current()->uri() == 'trips/previous')
		<li>
			<a class="sidenav-item" aria-selected="{{ (Route::current()->uri() == 'trips/active') ? 'true' : 'false' }}" href="{{ secure_url('/') }}/trips/active">{{trans('messages.sidenav.your_trip')}}</a>
		</li>

		<li>
			<a class="sidenav-item" aria-selected="{{ (Route::current()->uri() == 'trips/previous') ? 'true' : 'false' }}" href="{{ secure_url('/') }}/trips/previous">{{trans('messages.sidenav.previous_trip')}}</a>
		</li>
	@endif
