				...
				<div class="container-fluid min-height">
					...
					<div class="row">
						...
						<div class="col-md-12 p-0 mt-4">
							<form id="change_pass" class="{{ (Auth::guard('owner')->user()->password) ? 'show' : 'hide' }}" method='post' action="{{url('owner/security')}}">
								{{ csrf_field() }}
								<div class="form-group row">
									<input id="id" name="id" type="hidden" value="33661974">
									<input id="redirect_on_error" name="redirect_on_error" type="hidden" value="/owner/security">
