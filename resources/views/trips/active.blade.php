					...
					@forelse($bookings as $booking)
						...
						<div class="row border border p-2  rounded-3 mt-4">
							<div class="col-md-3 col-xl-4 p-2">
                                <div class="img-event">
                                    <a href="{{ secure_url('/') }}/properties/{{ $booking->properties->slug }}">
									...
									<div>
										...
										<p class="text-14 mt-3">
                                            @if($booking->status == 'Accepted')
                                                <span>
                                                    <a href="{{ secure_url('/') }}/booking/receipt?code={{ $booking->code }}">
                                            ...
                                            @elseif($booking->status == 'Processing' && $booking->payment_method_id <> 4)
                                                <span>
                                                    <a href="{{ secure_url('/') }}/booking_payment/{{ $booking->id }}">
									...
									<div class="pr-2 mt-5 mt-sm-0">
										<div class="align-self-center  mt-sm-0 w-100">
											<div class="row justify-content-center">
												<div class='img-round '>
													<a href="{{ secure_url('/') }}/users/show/{{ $booking->host_id}}">
											...
											<p class="text-center font-weight-700 mb-0">
												<a href="{{ secure_url('/') }}/users/show/{{ $booking->host_id}}" class="text-color text-color-hover">
