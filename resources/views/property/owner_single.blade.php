        ...
        <div class="col-lg-8 col-xl-9">
                    ...
                    <div class="text-center">
                        <a href="{{ url('users/show/'.$result->host_id) }}">
                            <img alt="User Profile Image" class="img-fluid rounded-circle mr-4 img-90x90"
                                src="{{ $result->owners->profile_image }}" title="{{$result->owners->username}}">
                        </a>
                    </div>
            ...
            <div class="mt-5">
                <div class="row">
                    ...
                    @if($result->owners->reviews->count())
                    <div class="col-md-12">
                        <p>{{ trans_choice('messages.reviews.review_other_properties', $result->owners->guest_review,
                            ['count'=>$result->owners->guest_review]) }}</p>
                        <p class="text-center mt-5 mb-4">
                            <a href="{{ url('users/show/'.$result->owners->id) }}"
                        ...
                        <div class="d-flex">
                            <div class="">
                                <div class="media-photo-badge text-center">
                                    <a href="{{ url('users/show/'.$row_review->owners->id) }}"><img
                                            alt="{{ $row_review->owners->username }}" class=""
                                            src="{{ $row_review->owners->profile_image }}"
                                            title="{{ $row_review->owners->username }}"></a>
                                </div>
                            </div>

                            <div class="ml-2 pt-2">
                                <a href="{{ url('users/show/'.$row_review->owners->id) }}">
                                    <h2 class="text-16 font-weight-700">{{ $row_review->owners->username }}</h2>
                                </a>
            ...
            <div class="mt-4">
                @if($result->owners->reviews->count() - $result->reviews->count())
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <p class="text-center mt-2">
                            <a target="blank"
                                ...
                                href="{{ url('users/show/'.$result->owners->id) }}">
                        ...
                        <div class="">
                            <div class="media-photo-badge text-center">
                                <a href="{{ url('users/show/'.$result->host_id) }}"><img
                                        alt="{{ $result->owners->username }}" class=""
                                        src="{{ $result->owners->profile_image }}"
                                        title="{{ $result->owners->username }}"></a>
                            </div>
                        </div>

                        <div class="ml-2 pt-3">
                            <a href="{{ url('users/show/'.$result->host_id) }}">
                                <h2 class="text-16 font-weight-700">{{ $result->owners->username }}</h2>
                            </a>
                            <p>{{trans('messages.users_show.member_since')}} {{ date('F Y',
                                strtotime($result->owners->created_at)) }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-4">
                <form accept-charset="UTF-8" method="post" action="{{ url('payments/book/'.$property_id) }}"
                    ...
                    <div id="book_it" class="mt-4">
                        ...
                        <div
                            class="book_btn col-md-12 text-center @if(Auth::user()) '' @else {{'display-off'}} @endif @if(Auth::guard('owner')->user()->id == $result->host_id) {{'display-off'}} @else '' @endif">
                        ...
                        <div>
                            <div class="profile-img pl-2 pr-1">
                                <a href="{{ url('users/show/'.$row_similar->host_id) }}"><img
                                        src="{{ $row_similar->owners->profile_image }}" alt="profile-photo"></a>
                            </div>
                        </div>
